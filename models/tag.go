...
func (o *Tag) Projects(mods ...qm.QueryMod) projectQuery {
	...
	queryMods = append(queryMods,
		qm.InnerJoin("\"project_tags\" on \"project\".\"id\" = \"project_tags\".\"project_id\""),
		qm.Where("\"project_tags\".\"tag_id\"=?", o.ID),
	)
...
func (tagL) LoadProjects(e boil.Executor, singular bool, maybeTag interface{}, mods queries.Applicator) error {
	var slice []*Tag
	var object *Tag
	...
	query := NewQuery(
		qm.Select("\"project\".id, \"project\".slug, \"project\".locked, \"project\".created_at, \"project\".updated_at, \"project\".published_at, \"project\".title, \"project\".description, \"project\".cover_id, \"project\".project_status, \"project\".series_status, \"project\".demographic, \"project\".rating, \"a\".\"tag_id\""),
		qm.From("\"project\""),
		qm.InnerJoin("\"project_tags\" as \"a\" on \"project\".\"id\" = \"a\".\"project_id\""),
...
func (o *Tag) AddProjects(exec boil.Executor, insert bool, related ...*Project) error {
	var err error
	...
	for _, rel := range related {
		query := "insert into \"project_tags\" (\"tag_id\", \"project_id\") values ($1, $2)"
...
// Sets o.R.Tags's Projects accordingly.
// Replaces o.R.Projects with related.
// Sets related.R.Tags's Projects accordingly.
func (o *Tag) SetProjects(exec boil.Executor, insert bool, related ...*Project) error {
	query := "delete from \"project_tags\" where \"tag_id\" = $1"
	...
	removeProjectsFromTagsSlice(o, related)
	if o.R != nil {
		o.R.Projects = nil
	}
...
// Sets related.R.Tags.
func (o *Tag) RemoveProjects(exec boil.Executor, related ...*Project) error {
	if len(related) == 0 {
		return nil
	}
	...
	var err error
	query := fmt.Sprintf(
		"delete from \"project_tags\" where \"tag_id\" = $1 and \"project_id\" in (%s)",
...
func removeProjectsFromTagsSlice(o *Tag, related []*Project) {
	for _, rel := range related {
		if rel.R == nil {
			continue
		}
